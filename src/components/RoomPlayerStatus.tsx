...
export function RoomPlayerStatus({
        ...
        return (
          <li
            ...
            className={`flex items-start gap-2 text-sm leading-snug ${
              p.submitted ? "text-emerald-700" : "text-[var(--color-ink-secondary)]"
            }`}
          >
  ...
  if (mode === "sidebar") {
    return (
      <div className="rounded-lg border border-[var(--color-border)]/80 bg-[var(--color-surface-muted)]/80 px-2.5 py-2">
  ...
  if (mode === "overlay") {
    const panel = !open ? (
      <button
        ...
        className="pointer-events-auto absolute left-0 top-1/2 z-20 -translate-y-1/2 rounded-r-lg border border-l-0 border-[var(--color-border)] bg-[var(--color-overlay)] px-1.5 py-3 text-[11px] font-medium text-[var(--color-ink-secondary)] shadow-sm backdrop-blur-sm"
      ...
      <div className="pointer-events-auto absolute left-2 top-2 z-20 max-w-[min(16rem,calc(100%-1rem))] rounded-lg border border-[var(--color-border)] bg-[var(--color-overlay)] px-3 py-2.5 shadow-md backdrop-blur-sm">
        <div className="mb-2 flex items-center justify-between gap-2">
          ...
          <button
            ...
            className="flex h-6 w-6 items-center justify-center rounded text-[var(--color-ink-muted)] hover:bg-[var(--color-bg)] hover:text-[var(--color-ink-secondary)]"
  ...
  if (mode === "inline") {
    return (
      <div
        className={`rounded-lg border border-[var(--color-border)] bg-[var(--color-overlay)] p-3 backdrop-blur-sm ${
